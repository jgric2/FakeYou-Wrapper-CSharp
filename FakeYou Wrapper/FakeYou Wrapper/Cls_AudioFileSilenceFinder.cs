...
static class AudioFileReaderExt
{
    ...
    public static double GetSilenceDuration(this AudioFileReader reader,double StartPosition, sbyte silenceThreshold = -4)
    {
        int counter = 0;
        bool eof = false;
        int initial = (int)(StartPosition * reader.WaveFormat.Channels * reader.WaveFormat.SampleRate / 1000);
    ...
    public static double GetSilenceDurationTest(this AudioFileReader reader, double StartPosition, sbyte silenceThreshold = -4)
    {
        int counter = 0;
        bool eof = false;
        int initial = (int)(StartPosition * reader.WaveFormat.Channels * reader.WaveFormat.SampleRate / 1000);
